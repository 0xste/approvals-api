...
import (
	...
	"github.com/0xste/approvals-api/pkg/protoc-gen-openapi/generator"
)
...
func main() {
	conf := generator.Configuration{
		FileName:      flags.String("file", "openapi", "file name to be generated to"),
		Version:       flags.String("version", "1.0.0", "version number text, e.g. 1.2.3"),
